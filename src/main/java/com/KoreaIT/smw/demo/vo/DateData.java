...
public class DateData {
	...
	// 달력만 사용시 사용될 생성자
	/*
	 * public DateData(String year, String month, String date, String value) { if
	 * ((month != null && month != "") && (date != null && date != "")) { this.year
	 * = year; this.month = month; this.date = date; this.value = value; } }
	 */
	public DateData() {
	}
