...
<c:set var="pageTitle" value="MapSearch" />
...
<div class="blinking-text" style="margin-left: 200px; width: 500px; text-align: center; position: absolute; top: 200px;">↓
		검색어를 입력해주세요(지역을 추가하면 자세히 찾기 가능 OR 괄호제거)</div>
<div class="map_wrap">
		<div id="map" style="width: 80%; height: 100%; position: relative; overflow: hidden; left: 150px;"></div>

		<div id="menu_wrap" class="bg_white" style="left: 150px;">
				<div class="option">
						<div>
...
<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=293b5b1a0d8e96a59ee9f418ae3e87b9&libraries=services"></script>
<script>
	//마커를 담을 배열입니다
