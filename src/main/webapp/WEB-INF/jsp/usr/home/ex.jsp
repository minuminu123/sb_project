  ...
  <line x1="0" y1="16" x2="40" y2="16" />
     ...
     <path d="m6 9 6 6 6-6" />
						...
						<div class="ticket-list">
								...
								<svg class="returning" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-switch-horizontal"
     ...
     <path d="m6 9 6 6 6-6" />
						...
						<div class="ticket-list">
								<svg class="settings" xmlns="http://www.w3.org/2000/svg"
										class="icon icon-tabler icon-tabler-adjustments-horizontal" width="44" height="44" viewBox="0 0 24 24"
